...
//buckethead_rally_zombie
    ...
    double dmg = 2;
    double aps = 3;
    string specials = "Bucket can be removed by Magnetshroom.";
...
//sunflower_zombie
    ...
    string appearance = "A flag zombie with a zombie head holding a flag with a leaf instead of a brain.";
    double hp = 10;
    double armor = 0;
    double speed = slow;
    double dmg = 1;
    double aps = 2;
    string specials = "Heals zombies that pass by him by 2hp.";
