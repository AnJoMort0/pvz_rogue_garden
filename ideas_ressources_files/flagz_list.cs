...
//brownparka_flag_zombie
    ...
    double dmg          = 1;
    double aps          = 2;
    string almanac      = "The brown parka is for the style, the flag is for the honour and the brain... well, it'll be for the decomposing stomach.";
    string origin       = "Rogue Garden";
...
//pogo_flag_zombie
    ...
    string origin       = "PvZ 1 (Pogo Zombie)";
...
//raincoat_flag_zombie
    ...
    string almanac      = "When not raiding lawns, Raincoat Flag Zombie can always be found raiding the clothing stores around town. Dr. Zomboss has saved loads on laundry, since Raincoat Flag Zombie never repeats a raincoat he's worn.";
